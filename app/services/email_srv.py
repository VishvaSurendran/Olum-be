...
def send_otp_email(recipient_email: str, otp_code: str):
    # --- DEMO BYPASS ---
    print(f"🚨 DEMO MODE: Ignored sending OTP {otp_code} to {recipient_email}")
    return  # Stop execution here so it doesn't try to connect to SMTP
...
def send_unanswered_question_email(admin_email: str, question: str):
    # --- DEMO BYPASS ---
    print(f"🚨 DEMO MODE: Ignored alert email for {admin_email} about: {question}")
    return
